            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                >
                    ...
                    <div className="text-center mb-8">
                        ...
                        >
                            <Mail size={32} style={{ color: '#EDEDDD' }} />
                        </div>
                        <h1
                    ...
                    <div className="text-center mt-6 pt-6 border-t border-opacity-20 opacity-0 animate-fadeIn animation-delay-1300"
                        style={{ borderColor: '#630000' }}
                    >
                        <Link to="/login"
                            className="font-semibold hover:underline transition-all duration-200 hover:scale-105 bg-transparent border-none cursor-pointer text-sm"
                            style={{ color: '#630000' }}
                        >
